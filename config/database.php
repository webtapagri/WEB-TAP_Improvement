    ...
    */
    ...
    'connections' => [
        ...
        'tapdw' => [
            'driver'   => 'oracle',
            'tns'      => env('DB_TNS', ''),
            'host'     => env('DB_HOST', '10.20.1.103'),
            'port'     => env('DB_PORT', '1521'),
            'database' => env('DB_DATABASE', 'tapdw'),
            'username' => env('DB_USERNAME', 'TAP_DW'),
            'password' => env('DB_PASSWORD', 'tapdw123#'),
