  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form method="post" action="{{ url('submitchangepass') }}" id="form" data-parsley-validate="">
            {{ csrf_field() }}
            <div class="form-group has-feedback">
                <input type="password" class="form-control" id="oldPass" placeholder="Password Lama" name="oldPass" required="">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" class="form-control" id="newPass" placeholder="Password Baru" name="newPass" required="">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" class="form-control" id="confNewPass" placeholder="Konfirmasi Password Baru" name="confNewPass" required="">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="form-group">
                <input class="btn btn-success btn-block btn-flat bg-green" value="Ubah Password" type="submit">
            </div>
        </form>
      </div><!-- /.login-box-body -->
      <div class="login-box-body">
