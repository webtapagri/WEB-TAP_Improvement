...
<head>
    ...
    <title>SS Online - @yield('tittle')</title>
    ...
    <style type="text/css">
		...
		.loader {
			border-top: 16px groove #5efc82;
			border-bottom: 16px groove #009624;
			border-left: 16px double #00c853;
			border-radius: 50%;
			width: 120px;
			height: 120px;
...
<body>
	...
	<div id="loadingSpinner" class="modal fade loader-container" role="dialog" data-keyboard="false" data-backdrop="static">
        ...
        function ceklogin() {
            ...
            $.ajax({
                ...
                if (data.success == true ) {
                    ...
                    //alert("Sesi Login Berubah, Pastikan Tidak ada yang Login selain anda!");
                    //window.location.replace('{{ url("/login") }}');

                    toastr8.warning({
						message:'Sesi Login Berubah', 
						title:"Sesi Login Berubah, Pastikan Tidak ada yang Login selain anda!"
					});
